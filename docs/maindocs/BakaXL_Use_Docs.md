...
1. 首先确认和您的好友的 Minecraft 都已启动，然后由房主（存档拥有者）进入「单人游戏」，打开一个世界
2. 按下 `Esc` 然后在暂停菜单中选择「对局域网开放」
3. 回到 BakaXL 大厅中选择您的 Minecraft 实例
4. 创建新大厅 `创建一个大厅` 将大厅 ID 通过通讯软件发送给其它玩家
5. 其他玩家使用大厅的8位数字 ID 加入。
...
5. 让您的好友登录 BakaXL 账户，启动游戏，加入大厅即可在多人游戏中看到您的游戏
